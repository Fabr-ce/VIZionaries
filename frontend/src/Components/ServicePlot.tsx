...
import convertToArea from "./convertToArea"

export default function ServicePlot({ data }: { data: serveData }) {
	const containerRef = useRef<HTMLDivElement>(null)

	const serviceData = useMemo(() => convertToArea(data), [data])
